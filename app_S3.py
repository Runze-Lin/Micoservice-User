...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://6156staticweb.s3.amazonaws.com"],  # Allows all origins
...
@app.get("/")
async def root():
    return RedirectResponse(url="https://6156staticweb.s3.amazonaws.com/static/index.html")
